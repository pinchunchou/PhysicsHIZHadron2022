...
BackgroundMCNoHF="--DoBackground true --HFShift 663 --Tolerance 10000000 --ToleranceFraction 0.001 --Oversample 1 --HFCeiling 134000 --VZTolerance 2 --MaximumCentrality 10"
