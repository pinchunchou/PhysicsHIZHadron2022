...
BackgroundMC="   --DoBackground true --HFShift 739.5  --Tolerance 390.7 --ToleranceFraction 0.001 --Oversample 1 --HFCeiling 134000 --DoMCHiBinShift false" # --MaximumCentrality 10
BackgroundMC1="  --DoBackground true --HFShift 770.4  --Tolerance 413.4 --ToleranceFraction 0.001 --Oversample 1 --HFCeiling 134000 --DoMCHiBinShift false" # --MaximumCentrality 10
BackgroundMC2="  --DoBackground true --HFShift 753.8  --Tolerance 408.3 --ToleranceFraction 0.001 --Oversample 1 --HFCeiling 134000 --DoMCHiBinShift false" # --MaximumCentrality 10
BackgroundMC3="  --DoBackground true --HFShift 721.9  --Tolerance 385.7 --ToleranceFraction 0.001 --Oversample 1 --HFCeiling 134000 --DoMCHiBinShift false" # --MaximumCentrality 10
...
BackgroundMCUEUp25="     --DoBackground true --HFShift 711.4   --Tolerance 187.5 --ToleranceFraction 0.001 --Oversample 10 --HFCeiling 134000"
...
BackgroundMCUEDown25="   --DoBackground true --HFShift 676.7   --Tolerance 187.5 --ToleranceFraction 0.001 --Oversample 10 --HFCeiling 134000"
...
PPSigBkgMC="   --DoBackground true --CheckForBackgroundZ true --HFShift 0 --Tolerance 1875 --ToleranceFraction 0.001 --Oversample 10 --HFCeiling 134000"
PPSigBkgGenMC="--DoBackground true --CheckForBackgroundZ true --HFShift 0 --Tolerance 1875 --ToleranceFraction 0.001 --Oversample 10 --HFCeiling 156000 --VZTolerance 10000"
PPSigBkgData=" --DoBackground true --CheckForBackgroundZ true --HFShift 0 --Tolerance 1500 --ToleranceFraction 0.001 --Oversample 25 --HFCeiling  70000"

SigBkgMC="   --DoBackground true --CheckForBackgroundZ true --HFShift 0 --Tolerance 1875 --ToleranceFraction 0.001 --Oversample 5 --HFCeiling 134000"
SigBkgGenMC="--DoBackground true --CheckForBackgroundZ true --HFShift 0 --Tolerance 1875 --ToleranceFraction 0.001 --Oversample 10 --HFCeiling 156000 --VZTolerance 10000"
SigBkgData=" --DoBackground true --CheckForBackgroundZ true --HFShift 0 --Tolerance 1500 --ToleranceFraction 0.001 --Oversample 25 --HFCeiling  70000"
...
DHSet Setting.dh PbPbBackgroundMCNoHF Nominal string "$Common $MC   --IsPP false $MiniAODPF $PbPbJetMC    $PbPbRecoTrack  $BackgroundMCNoHF"
DHSet Setting.dh PbPbBackgroundMCNoVZ Nominal string "$Common $MC   --IsPP false $MiniAODPF $PbPbJetMC    $PbPbRecoTrack  $BackgroundMCNoVZ"
DHSet Setting.dh PbPbBackgroundMCNoHFVZ Nominal string "$Common $MC --IsPP false $MiniAODPF $PbPbJetMC    $PbPbRecoTrack  $BackgroundMCNoHFVZ"
DHSet Setting.dh PbPbBackgroundMCNoHFVZ_NoHiBinShift Nominal string "$Common $MC --IsPP false $MiniAODPF $PbPbJetMC    $PbPbRecoTrack  $BackgroundMCNoHFVZ  --DoMCHiBinShift false"
...
DHSet Setting.dh PbPbBackgroundMC3    Nominal string "$Common $MC    --IsPP false $MiniAODPF $PbPbJetMC    $PbPbRecoTrack  $BackgroundMC3"
