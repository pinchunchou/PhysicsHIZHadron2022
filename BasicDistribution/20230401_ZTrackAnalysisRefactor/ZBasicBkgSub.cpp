...
const char *typeofdata = "v18_PFmuon/20240328/Reco_V18c_694_PPGen0NPU";
   ...
   string HistName="HPhi", string XTitleName = "#Delta#phi_{Z,track}", string YTitleName = "dN/d#Delta#phi", int rebinnum=1)
{
   ...
   if(selfmix)
      ...
      leg1.AddEntry(hpp_phi ,Form("GEN pp%s (NPU=0)",genlegtxt.c_str()),"l");
...
int main(int argc, char *argv[]){
   ...
   if(isgen)
      ...
      file_sigMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSignal_v18c_PFmuon.root","read");
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18c_cent10.root","read");
   }
   ...
   if(isgen)
      ...
      file_ppMC  = TFile::Open("~/eos_base/BasicPlots/GraphPPMCGen0NPU_v18_mZ.root","read");
