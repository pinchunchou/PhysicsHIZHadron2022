...
const char *typeofdata = "v18_PFmuon/20240504/Reco_v18e_754_408_ov1_hibin0";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18e_754_408_ov1_hibin0.root","read");
   }
