...
const char *typeofdata = "v18_PFmuon/20240430/Reco_v18d_NoHF_NoNcoll";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18d_NoHF_NoNcoll.root","read");
      else
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18d_NoHF_NoNcoll.root","read");
   }
