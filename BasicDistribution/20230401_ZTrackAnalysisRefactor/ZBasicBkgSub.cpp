...
const char *typeofdata = "v18_PFmuon/20240504/Reco_v18e_NoHFVZ_770_413_ov1_hiBin0";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18e_770_413_ov1_hibin0.root","read");
   }
