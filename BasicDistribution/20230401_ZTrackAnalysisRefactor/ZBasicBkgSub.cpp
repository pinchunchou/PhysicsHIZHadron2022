...
const char *typeofdata = "v18_PFmuon/20240516/Reco_v18e_800_800_ov1_pt40";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18e_800_800_ov1_hibin3_pt40.root","read");
   }
