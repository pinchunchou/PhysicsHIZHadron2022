...
const char *typeofdata = "v18_PFmuon/20240328/Reco_V18c_694_ov10_UEUp25";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackgroundUEUp25_v18c_694_1.root","read");
   }
