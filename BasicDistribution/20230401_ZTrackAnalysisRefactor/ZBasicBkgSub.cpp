...
const char *typeofdata = "v18_PFmuon/20240410/Reco_v18c_663_tol671_ov1_siggen";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18c_663_tol671_ov1.root","read");
      else
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18c_663_tol671_ov1.root","read");
   }
