...
const char *typeofdata = "v18_PFmuon/20240328/Reco_V18c_655_tol120_ov1";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18c_655_tol120_ov1.root","read");
   }
