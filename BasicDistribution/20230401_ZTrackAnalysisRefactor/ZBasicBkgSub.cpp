...
const char *typeofdata = "v18_PFmuon/20240402/Reco_v18c_694_ov10_notrkres";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18c_694_ov10_notrkres.root","read");
      else
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18c_694_ov10_notrkres.root","read");
   }
