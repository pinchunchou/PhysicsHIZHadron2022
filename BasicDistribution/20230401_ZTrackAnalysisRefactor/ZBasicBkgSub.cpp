...
const char *typeofdata = "v18_PFmuon/20240425/Reco_v18d_onlyTrknResW";
...
int main(int argc, char *argv[]){
   ...
   if(isgen)
      file_sigMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSignal_v18d_PFmuon_onlyTrknResW.root","read");
   else
      file_sigMC = TFile::Open("~/eos_base/BasicPlots/GraphMCSignal_v18d_PFmuon_onlyTrknResW.root","read");
   ...
   if(selfmix)
      ...
      if(isgen)
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18d_ov1_onlyTrknResW.root","read");
      else
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18d_ov1_onlyTrknResW.root","read");
   }
