...
const char *typeofdata = "v18_PFmuon/20240328/Reco_V18c_694_ov10_UEDown25";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackgroundUEDown25_v18c_694_1.root","read");
   }
   ...
   if(isgen)
      ...
      file_ppMC  = TFile::Open("~/eos_base/BasicPlots/GraphPPMC0NPU_v18c.root","read");
