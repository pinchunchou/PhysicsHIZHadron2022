...
const char *typeofdata = "v18_PFmuon/20240503/Reco_v18e_1100_671_ov1";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18e_1100_671_ov1.root","read");
      else
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18e_1100_671_ov1.root","read");
   }
