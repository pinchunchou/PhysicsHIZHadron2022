...
const char *typeofdata = "v18_PFmuon/20240518/Reco_v18e_800_400_ov1_pt40_200";
...
int main(int argc, char *argv[]){
   ...
   if(selfmix)
      ...
      if(isgen)
         ...
         file_bkgMC = TFile::Open("~/eos_base/BasicPlots/GraphMCBackground_v18e_800_400_ov1_hibin3_pt40_200.root","read");
   }
